...
#define VEC_DEFINE(T)                                                                                      \
    ...
    void vector_init_##T(Vec_##T** vec) {                                                                  \
    ...
    bool vector_resize_##T(Vec_##T* vec, size_t new_size) {                                                \
    ...
    void vector_push_back_##T(Vec_##T* vec, T value) {                                                     \
    ...
    void vector_free_##T(Vec_##T** vec) {                                                                  \
    ...
    void vector_remove_##T(Vec_##T* vec, size_t index) {                                                   \
        if (index >= vec->size) {                                                                          \
    ...
    bool vector_insert_##T(Vec_##T* vec, size_t index, T value) {                                          \
        if (index > vec->size) {                                                                           \
            printf("Index out of bounds\n");                                                               \
            return false;                                                                                  \
        }                                                                                                  \
    ...
    bool vector_get_##T(Vec_##T* vec, size_t index, T* result) {                                           \
        if (index >= vec->size) {                                                                          \
            printf("Index out of bounds\n");                                                               \
            return false;                                                                                  \
        }                                                                                                  \
    ...
    bool vector_pop_back_##T(Vec_##T* vec, T* result) {                                                    \
        if (vec->size == 0) {                                                                              \
            return false;                                                                                  \
        }                                                                                                  \
        vec->size--;                                                                                       \
    ...
    void vector_clear_##T(Vec_##T* vec) {                                                                  \
        vec->size = 0;                                                                                     \
        if (vec->capacity > 0) {                                                                           \
    ...
    void vector_sort_##T(Vec_##T* vec, int (*comparator)(const void*, const void*)) {                      \
